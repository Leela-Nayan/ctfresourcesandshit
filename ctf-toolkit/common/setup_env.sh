...
echo ""
echo "--- Core Tools ---"
CORE_TOOLS="python3 python3-pip gdb git curl wget netcat-openbsd socat file binutils"
...
BIN_TOOLS="checksec ltrace strace upx-ucl"
...
echo -n "seccomp-tools:"; seccomp-tools --version 2>/dev/null || echo " NOT FOUND"
